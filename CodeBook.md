...
The domain for names with "t" as in "tBodyAcc-mean-X" is time, and the domain for names with "f" as in "fBodyAcc-mean-X" is frequency. Domain described instead of units since all variables were normalized and bounded within [-1,1].
